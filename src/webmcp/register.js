...
export function registerResearchWebMCPTools(editorState, ownerDocument = document) {
  ...
  const registrationState = {
    ...
    toolNames: [...READ_ONLY_WEBMCP_TOOL_NAMES, ...ACTION_WEBMCP_TOOL_NAMES],
    registration: null,
  };
  ...
  const tools = [...buildResearchWebMCPTools(editorState), ...buildResearchWebMCPActionTools(editorState)];
