...
export function buildDemoResearchProject(markdown) {
  const experiments = [
    run({
      ...
      metricHistory: {
        reasoning_index: history([0.412, 0.493, 0.548, 0.589, 0.617, 0.638]),
        training_loss: history([3.21, 2.79, 2.53, 2.31, 2.19, 2.12]),
      },
      artifacts: [
        { id: "dense-checkpoint", label: "Dense baseline checkpoint", type: "model", uri: "demo-research/models/astra-dense-34b.safetensors" },
      ],
    ...
    run({
      ...
      metricHistory: {
        reasoning_index: history([0.489, 0.556, 0.612, 0.658, 0.689, 0.711]),
        training_loss: history([3.06, 2.61, 2.34, 2.17, 2.05, 1.97]),
      },
    ...
    run({
      ...
      metricHistory: {
        reasoning_index: history([0.631, 0.674, 0.708, 0.734, 0.754, 0.769]),
        retrieval_128k: history([0.312, 0.487, 0.664, 0.801, 0.881, 0.926]),
      },
    ...
    run({
      ...
      metricHistory: {
        reasoning_index: history([0.742, 0.751, 0.759, 0.766, 0.772, 0.776]),
        tool_completion: history([0.701, 0.748, 0.782, 0.808, 0.826, 0.839]),
      },
      artifacts: [
        { id: "tool-ablation", label: "Execution-feedback ablation", type: "table", uri: "demo-research/tables/tool-feedback-ablation.csv" },
      ],
    ...
    run({
      ...
      metrics: {
        reasoning_index: 0.784,
        tool_completion: 0.847,
        retrieval_128k: 0.951,
        hallucination_rate: 0.058,
        calibration_error: 0.039,
        tokens_per_second: 59,
      },
      metricHistory: {
        reasoning_index: history([0.702, 0.728, 0.746, 0.759, 0.769, 0.776, 0.781, 0.784]),
        tool_completion: history([0.692, 0.731, 0.768, 0.794, 0.817, 0.831, 0.841, 0.847]),
      },
      artifacts: [
  ...
  const e = (id, type, kind, label, artifactId, experimentId, commit, metric, value, uri, notes) => ({
    id,
    type,
    evidenceKind: kind,
    label,
  ...
  const evidence = [
    e(
      "astra-evidence-eval-v2",
      "experiment-result",
      "quantitative-result",
      "Locked Astra scorecard",
      "astra-locked-eval",
      "astra-run-254",
      "f6a57aa",
      "reasoning_index=78.4%",
      "78.4%",
      "demo-research/results/astra-eval-v2.json",
      "Frozen aggregate from math, code repair, grounded browser tasks, and retrieval.",
    ),
    e(
      "astra-evidence-data",
      "dataset",
      "quantitative-result",
      "Astra pretraining manifest",
      "astra-pretrain-mixture@4.2",
      "astra-run-226",
      "b8fc204",
      "deduplicated_tokens=2.4T",
      "2.4T",
      "demo-research/data/astra-pretrain-manifest.json",
      "Synthetic token mixture, filters, licenses, and contamination audit.",
    ),
    e(
      "astra-evidence-config-v2",
      "configuration",
      "methodological-configuration",
      "Locked post-training configuration",
      "astra-posttrain-config-v2",
      "astra-run-254",
      "f6a57aa",
      "learning_rate=2e-5",
      "2e-5",
      "demo-research/configs/astra-posttrain-v2.yaml",
      "Exact optimizer and execution-feedback configuration for the locked checkpoint.",
    ),
    e(
      "astra-evidence-table-v2",
      "table-source",
      "table-generating-result",
      "Astra model comparison",
      "astra-comparison-v2",
      "astra-run-254",
      "f6a57aa",
      "baseline=63.8%; final=78.4%",
      "78.4%",
      "demo-research/tables/astra-comparison-v2.csv",
      "Cross-run scorecard generated from the experiment registry.",
    ),
    e(
      "astra-evidence-figure-v2",
      "figure-source",
      "figure-generating-result",
      "Astra evaluation figure",
      "astra-evaluation-figure",
      "astra-run-254",
      "f6a57aa",
      "reasoning_index=78.4%",
      "78.4%",
      "demo/astra-evaluation-v2.svg",
      "Regenerated from the locked scorecard.",
    ),
    e(
      "astra-evidence-reasoning",
      "experiment-result",
      "quantitative-result",
      "Locked reasoning index",
      "astra-locked-eval",
      "astra-run-254",
      "f6a57aa",
      "reasoning_index=78.4%",
      "78.4%",
      "demo-research/results/astra-eval-v2.json",
      "The locked harness supersedes the 76.9% manuscript candidate.",
    ),
    e(
      "astra-evidence-ablation",
      "analysis-artifact",
      "quantitative-result",
      "Execution-feedback ablation",
      "tool-ablation",
      "astra-run-248",
      "e11bc92",
      "tool_completion_delta=9.6",
      9.6,
      "demo-research/tables/tool-feedback-ablation.csv",
      "Controlled removal of sandbox execution feedback, measured in percentage points.",
    ),
    e(
      "astra-evidence-model",
      "implementation",
      "implementation",
      "Astra research model card",
      "astra-model-card",
      "astra-run-254",
      "f6a57aa",
      "parameters_total=126B; parameters_active=31B",
      "126B / 31B",
      "demo-research/models/astra-model-card.md",
      "Synthetic model identity, architecture, limitations, and disclosure.",
    ),
    e(
      "astra-evidence-code",
      "evaluation-script",
      "implementation",
      "Frozen Astra evaluation harness",
      "astra-eval-code",
      "astra-run-254",
      "f6a57aa",
      "protocol=frozen-harness",
      "frozen-harness",
      "demo-research/scripts/evaluate_astra.py",
      "Deterministic entry point pinned to astra-eval-lock@1 with immutable prompt hashes.",
    ),
    e(
      "astra-evidence-failure",
      "result-file",
      "negative-result",
      "Router collapse trace",
      "router-collapse-log",
      "astra-run-212",
      "a1d09ef",
      "expert_concentration=61%",
      "61%",
      "demo-research/logs/astra-router-collapse.txt",
      "Preserved negative result from the aggressive router-temperature sweep.",
    ),
  ];
  ...
  const objects = [
    {
      ...
      createdAt: DEMO_TIME,
      updatedAt: DEMO_TIME,
      verification: verification("contradicted", "contradicted", "The manuscript reports 76.9%, while the locked Astra evaluation reports 78.4%.", [
        { ...refs["astra-evidence-reasoning"], metric: "reasoning_index=76.9%", commit: "d9a42c7", experimentId: "astra-run-239" },
      ]),
    },
    {
      id: "astra-object-data-claim",
      kind: "claim",
      subtype: "quantitative-result",
      text: snippets.data,
      ...
      createdAt: DEMO_TIME,
      updatedAt: DEMO_TIME,
      verification: verification("verified", "verified", "The manuscript count matches the versioned synthetic data manifest.", [
        refs["astra-evidence-data"],
      ]),
    },
    {
      id: "astra-object-method",
      kind: "method",
      subtype: null,
      ...
      createdAt: DEMO_TIME,
      updatedAt: DEMO_TIME,
      verification: verification("stale", "stale", "The locked post-training configuration uses 2e-5 rather than the pretraining peak.", [
        {
          ...refs["astra-evidence-config-v2"],
          artifactId: "astra-pretrain-config-v1",
          commit: "d9a42c7",
          metric: "learning_rate=2.4e-4",
          uri: "demo-research/configs/astra-pretrain-v1.yaml",
        },
      ]),
    },
    {
      id: "astra-object-table",
      kind: "table",
      subtype: null,
      text: snippets.table,
      ...
      createdAt: DEMO_TIME,
      updatedAt: DEMO_TIME,
      verification: verification("stale", "stale", "The comparison table predates post-training and the locked evaluation.", [
        {
          ...refs["astra-evidence-table-v2"],
          artifactId: "astra-comparison-v1",
          commit: "d9a42c7",
          metric: "baseline=63.8%; candidate=76.9%",
          uri: "demo-research/tables/astra-comparison-v1.csv",
        },
      ]),
    },
    {
      id: "astra-object-figure",
      kind: "figure",
      subtype: null,
      ...
      verification: verification("stale", "stale", "The displayed figure predates the locked replacement run.", [
        {
          ...refs["astra-evidence-figure-v2"],
          artifactId: "astra-evaluation-v1",
          commit: "d9a42c7",
          metric: "reasoning_index=76.9%",
          uri: "demo/astra-evaluation-v1.svg",
        },
      ]),
    },
    {
      id: "astra-object-ablation-claim",
      kind: "claim",
      subtype: "quantitative-result",
      text: snippets.ablation,
      anchor: anchorFor(markdown, snippets.ablation),
      verificationState: "verified",
      createdAt: DEMO_TIME,
      updatedAt: DEMO_TIME,
      verification: verification("verified", "verified", "The execution-feedback ablation reproduces the reported 9.6-point decrease.", [
        refs["astra-evidence-ablation"],
      ]),
    },
    {
      id: "astra-object-model-claim",
      kind: "claim",
      subtype: "quantitative-result",
      text: snippets.model,
      anchor: anchorFor(markdown, snippets.model),
      verificationState: "verified",
      createdAt: DEMO_TIME,
      updatedAt: DEMO_TIME,
      verification: verification("verified", "verified", "The model card records 126B total parameters and 31B active parameters per token.", [
        refs["astra-evidence-model"],
      ]),
    },
    {
      id: "astra-object-eval-method",
      kind: "method",
      subtype: null,
      text: snippets.code,
      anchor: anchorFor(markdown, snippets.code),
      verificationState: "verified",
      createdAt: DEMO_TIME,
      updatedAt: DEMO_TIME,
      verification: verification("verified", "verified", "The frozen evaluation entry point is pinned to astra-eval-lock@1.", [
        refs["astra-evidence-code"],
      ]),
    },
    {
      id: "astra-object-router-claim",
      kind: "claim",
      subtype: "quantitative-result",
      text: snippets.failure,
      anchor: anchorFor(markdown, snippets.failure),
      verificationState: "verified",
      createdAt: DEMO_TIME,
      updatedAt: DEMO_TIME,
      verification: verification("verified", "verified", "The retained failure trace records 61% expert concentration.", [
        refs["astra-evidence-failure"],
      ]),
    },
  ];
  const linkSpecs = [
  ...
  const links = linkSpecs.map(([objectId, evidenceId, relation], index) => ({
    id: `astra-link-${index + 1}`,
    objectId,
    evidenceId,
    relation,
    createdAt: DEMO_TIME,
